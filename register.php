...
<head>
    ...
    <title>Berkah Mebel Ayu - Daftar Akun</title>
    ...
    <div class="register-container min-h-screen flex items-center justify-center p-4">
        ...
        <div class="w-full max-w-lg">
            <div class="text-center mb-6 relative z-10">
                ...
                <h1 class="text-3xl font-bold text-white tracking-wide drop-shadow-md">Daftar Akun Baru</h1>
                <p class="text-amber-100 italic">Bergabunglah dengan ribuan pelanggan setia Berkah Mebel</p>
            </div>

            <!-- Pesan Error -->
            <?php if (isset($_SESSION['register_error'])): ?>
                <div class="mb-4 p-4 bg-red-100 border-2 border-red-400 text-red-700 rounded-xl text-center flex items-center justify-center">
            ...
            <div class="glass-card rounded-[2.5rem] shadow-2xl p-8 md:p-10">
                <form method="POST" action="register_process.php" class="grid grid-cols-1 md:grid-cols-2 gap-4" id="registerForm">
                    <div class="md:col-span-2">
                        <label class="block text-amber-900 text-sm font-bold mb-2 ml-1">
                            <i class="fas fa-user-tie mr-2"></i>Nama Lengkap *
                        </label>
                        <input type="text" name="name" class="form-input w-full px-4 py-3 bg-amber-50/50 border-2 border-amber-200 rounded-2xl focus:border-amber-600 focus:outline-none transition-all" placeholder="Nama Anda" required>
                    </div>
                    ...
                    <div class="md:col-span-1">
                        ...
                        <input type="email" name="email" class="form-input w-full px-4 py-3 bg-amber-50/50 border-2 border-amber-200 rounded-2xl focus:border-amber-600 focus:outline-none transition-all" placeholder="email@anda.com" required>
                    </div>
                    ...
                    <div class="md:col-span-1">
                        ...
                        <input type="tel" name="phone" class="form-input w-full px-4 py-3 bg-amber-50/50 border-2 border-amber-200 rounded-2xl focus:border-amber-600 focus:outline-none transition-all" placeholder="08xxxxxxxxxx" required>
                    </div>
                    ...
                    <div class="md:col-span-1">
                        ...
                        <input type="password" name="password" class="form-input w-full px-4 py-3 bg-amber-50/50 border-2 border-amber-200 rounded-2xl focus:border-amber-600 focus:outline-none transition-all" placeholder="••••••" minlength="6" required>
                    ...
                    <div class="md:col-span-1">
                        ...
                        <input type="password" name="password_confirm" class="form-input w-full px-4 py-3 bg-amber-50/50 border-2 border-amber-200 rounded-2xl focus:border-amber-600 focus:outline-none transition-all" placeholder="••••••" minlength="6" required>
                    </div>

                    <div class="md:col-span-2">
                        <label class="flex items-start cursor-pointer p-3 bg-amber-100/30 rounded-xl hover:bg-amber-100/50 transition">
                            <input type="checkbox" name="terms" class="w-5 h-5 text-amber-700 rounded border-2 border-amber-300 focus:ring-2 focus:ring-amber-500 cursor-pointer mt-0.5" required>
                            <span class="ml-3 text-sm text-amber-900">Saya menyetujui <a href="#" class="text-amber-900 font-bold hover:underline">Syarat & Ketentuan</a> dan <a href="#" class="text-amber-900 font-bold hover:underline">Kebijakan Privasi</a></span>
                        </label>
                    </div>
                ...
                <div class="text-center mt-8 pt-6 border-t border-amber-200">
                    <p class="text-gray-700 text-sm mb-4">Sudah memiliki akun? 
                        <a href="login.php" class="text-amber-800 font-bold hover:text-amber-900 underline decoration-amber-300">Masuk di sini</a>
                    </p>
                    <a href="index.php" class="inline-block text-sm text-gray-600 hover:text-amber-700 transition">
