-- Berkah Mebel Ayu - Database Tables Only
-- NOTE: Jangan gunakan CREATE DATABASE dan USE - database sudah dibuat di Control Panel
-- Pastikan untuk memilih database yang benar di InfinityFree Control Panel
...
INSERT IGNORE INTO `users` (`name`, `email`, `password`, `phone`, `address`, `city`, `province`, `postal_code`) VALUES
...
-- Insert Produk Demo (jika belum ada)
INSERT IGNORE INTO `products` (`name`, `category`, `description`, `price`, `discount_price`, `stock`, `image`, `is_featured`) VALUES
...
('Tempat Tidur King Size', 'Tempat Tidur', 'Tempat tidur dengan frame kayu solid dan desain minimalis elegan', 1200000, 720000, 3, 'tempat-tidur.jpg', TRUE),
